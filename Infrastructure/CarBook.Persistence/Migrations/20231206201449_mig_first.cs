        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarID = table.Column<int>(type: "int", nullable: false),
                    FeatureID = table.Column<int>(type: "int", nullable: false),
                    Avaílable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarPrisingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarID = table.Column<int>(type: "int", nullable: false),
                    PricingID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarPrisings", x => x.CarPrisingID);
                    table.ForeignKey(
                        name: "FK_CarPrisings_Cars_CarID",
                        column: x => x.CarID,
                        principalTable: "Cars",
                        principalColumn: "CarID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarPrisings_Pricings_PricingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarPrisings_CarID",
                table: "CarPrisings",
                column: "CarID");

            migrationBuilder.CreateIndex(
                name: "IX_CarPrisings_PricingID",
                table: "CarPrisings",
                column: "PricingID");
